...
export default function AddTaskModal({ onSave }: { onSave: (task: any) => void }) {
    ...
    return (
        <div className='relative z-50 flex items-center justify-center inset-0 bg-black'>
            <form
                className="absolute mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%] bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11"
            >
                <h2
